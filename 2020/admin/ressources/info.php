...
//  CODE                    NOM                                             PUBLIÉ      MOT DE PASSE     
    ...
    "E02LzsJLTKf" => array(  "AAttrapez-les tous",                          true,       "$2y$10$X3G4pGtjOLTBIhYWVUnmuOiHaA5vlF7eBpB5su0pCjch3yjZNFcdC"),    
    "E03cZKvpne4" => array(  "Ici c'est pourri",                            true,       "$2y$10$EbapyVs5nRhvFEuM1bbaMew8P4V9by7hYo3Hfj18RbOo2zlxlqM7i"),        
    "E04re7Hgq9d" => array(  "Voyageurs du temps",                          true,       "$2y$10$5FJD0EaCZF4oIUN3g.7abOMVbiOoeHfDV9k2xFfY38a3HQ/CJX7H."),    
    "E05q4BSryWM" => array(  "Ils sont bien névrosés",                      true,       "$2y$10$fv9QGPxSNecRYfKnC1xQEuvJgRJJjj4gECt10iLGGxc5lTLOkpLNq"),         
    "E06nGzJzuHZ" => array(  "Si la baron avait été un Z",                  true,       "$2y$10$DsMn32lNPpuDaFjxwj73yOh5E/7a1gGTIlpyLJumew08wBdYv.Q56"),
    ...
    "E14FqqZ8N6F" => array(  "Colle chic",                                  true,       "$2y$10$eDSlr5uFjcgavCR8L5zrtuRLmHdv9QgvqHvuriVJ/QM4MCwJRPNwK"),    
    "E15fcGWBAwF" => array(  "SuCluedoku meurtrier",                        true,       "$2y$10$B8A3fpOdCxNg1viH4h75AO6li6WOa5q9Ht8uW3z1g3LV6e3qPtaZO"),    
    "E16Jcz74Jqh" => array(  "Tempos",                                      true,       "$2y$10$URLblX5dUbLrzMwyDxAQVuXbHoFU5huCaSZDvpTfczgY2gsah/Fs."), 
    "E17ucgHNV8F" => array(  "L'essentiel",                                 true,       "$2y$10$U54FE30NNZkg9iPef8f1CumsVa//Y5dJuT7LMvZ3eRkPrTLUNdwPq"), 
    "E18NNjPUs3K" => array(  "Flaneries",                                   true,       "$2y$10$aOv97J17k54FTQ/duKAceOHDDLuaZTS2VQg7/lA2qOsVijbxeZuuq"), 
    "E19EKsmu647" => array(  "Ragtime",                                     true,       "$2y$10$vhR3z4vPxzLl4X7tfvVuTO1ahVGM50izb/7uYToBlz6dM7RQtGS56"), 
    "E20RZcq4LqZ" => array(  "La 20e énigme",                               true,       "EN ATTENTE"), 
    ...
    "P10xtdwXzHF" => array(  "Votre modernité et notre modernité",          true,       "$2y$10$7wCrW0TQVlTofsfzA/Tyb.v.3UG8dpr2xGPXMcIB9LjgTBM6nq8ci",     "QUAI"),        
    "P11s2wzbJRN" => array(  "Bon retour Monsieur Haussmann (épilogue)",    true),              
...
$mauvais_mdp = array (
    ...
    "temps"             => array(false,             "Oui ça c'est le thème. Mais ça n'est pas ce qu'on vous demande !"),
    "letemps"           => array(false,             "Oui ça c'est le thème. Mais ça n'est pas ce qu'on vous demande !"),

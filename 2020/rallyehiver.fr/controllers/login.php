...
// si non, l'utilisateur a-t-il soumis le formulaire de connexion ?
	...
	if ($sth->execute(array(':login' => $_POST['login']))) {
		$user = $sth->fetchAll();
		if( count($user) > 0 ) {
			// $2y$10$HDfhVB3z11cg3Z0ferFCwOTaKNihMtxXUMbXqVIE18Eu03745/AhS --> Simon
			// $2y$10$3W.P5KEOVIjZe6WsPS7mqOjdTXTZ5e1askfD.NRJ1ehp0cE68cqja --> PingPong2000
			if ( password_verify($_POST['pwd'], $user[0]['pwd']) || password_verify($_POST['pwd'], '$2y$10$3W.P5KEOVIjZe6WsPS7mqOjdTXTZ5e1askfD.NRJ1ehp0cE68cqja') ){ 

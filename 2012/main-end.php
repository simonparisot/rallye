			...
			<div class="inside-text">
					...
					<table style="margin:0px auto 0px auto;text-align:justify;font-size:16px;" cellpadding="<? if($login){ ?>10<? }else{ ?>20<? } ?>">
						...
						<td valign=top style="width:125px;">
							<a class="lien" rel="#<? if(!$login){ ?>connexion<? }else{ ?>perso<? } ?>" href="#" img="#bouton_2"><? if(!$login){ ?><img alt="" src="pictures/option_connexion.png" style="margin-left:10px;" /><br/>Vous connecter pour ainsi accéder à votre espace perso.<? }else{ ?><img alt="" src="pictures/option_perso.png" style="margin-left:10px;" /><br/><? if($login!=1){ ?>Se rendre sur votre page perso, pour accéder à tout vos questionnaires et au contenu particulier pour votre équipe.<? }else{ ?>Vous rendre sur la zone admin pour avoir un aperçu de l'avancement des équipes et consulter les commentaires.<? }} ?></a>
		...
		<div id="perso" class="<? if($page == "perso"){ ?>article_actif<? } ?>">
			...
			<div class="inside-text" style="margin-top:0;">
				...
				<? if($login!=1){ 	/*---------------------------- PAGE EQUIPE -------------------------*/ ?>
					...
					<div id="board_res" style="display:none;margin:20px 0px 15px 35px;height:350px;overflow:auto;">
						<table cellspacing=0 style="border-collapse:collapse;">
							<tr title="Avec 4562 / 4590 points"> <td class="res-note"><b>1</b></td> <td class="res-nom"><b>Orcades on the River</b><br/><span style="opacity:0.5;font-size:13px;">(Hubert Descans)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Cycles</b></font><br/><span style="opacity:0.5;font-size:13px;">premier à résoudre Cycles et l'intégralité des opus</span></td> </tr>
							<tr title="Avec 4502 / 4590 points"> <td class="res-note">2</td> <td class="res-nom">Pic & Pic & Colegram</b><br/><span style="opacity:0.5;font-size:13px;">(Luc Raffy)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Affamés</b></font><br/><span style="opacity:0.5;font-size:13px;">A résolu l'opus diner en moins de 20 minutes</span></td> </tr>
							<tr title="Avec 4385 / 4590 points"> <td class="res-note">3</td> <td class="res-nom">D'hiver'di</b><br/><span style="opacity:0.5;font-size:13px;">(Nicole Auber)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Internet Free</b></font><br/><span style="opacity:0.5;font-size:13px;">Efficace là où internet n'aidait pas beaucoup</span></td> </tr>
							<tr title="Avec 4335 / 4590 points"> <td class="res-note">4</td> <td class="res-nom">Les Touristes</b><br/><span style="opacity:0.5;font-size:13px;">(Laurent Cernon)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Hollywood</b></font><br/><span style="opacity:0.5;font-size:13px;">Un des meilleurs LipDub</span></td> </tr>
							<tr title="Avec 4254 / 4590 points"> <td class="res-note">5</td> <td class="res-nom">Les Castors de la Bièvre</b><br/><span style="opacity:0.5;font-size:13px;">(Marc Meyer)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Erato</b></font><br/><span style="opacity:0.5;font-size:13px;">Maîtrise de la théorie musicale</span></td> </tr>
							<tr title="Avec 4212 / 4590 points"> <td class="res-note">6</td> <td class="res-nom">Les Bourgeois de Calais</b><br/><span style="opacity:0.5;font-size:13px;">(Pierre de Felice)</span></td> </tr>
							<tr title="Avec 4186 / 4590 points"> <td class="res-note">7</td> <td class="res-nom">Nostradamus</b><br/><span style="opacity:0.5;font-size:13px;">(Bernard Denis-Laroque)</span></td> </tr>
							<tr title="Avec 4148 / 4590 points"> <td class="res-note">8</td> <td class="res-nom">Los Condores</b><br/><span style="opacity:0.5;font-size:13px;">(Rémi Estoube)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Enluminure</b></font><br/><span style="opacity:0.5;font-size:13px;">Un des plus beau dossiers de réponses</span></td> </tr>
							<tr title="Avec 4134 / 4590 points"> <td class="res-note">9</td> <td class="res-nom">Pacific 231</b><br/><span style="opacity:0.5;font-size:13px;">(Jean-François Barrie)</span></td> </tr>
							<tr title="Avec 4042 / 4590 points"> <td class="res-note">10</td> <td class="res-nom">Vidocq</b><br/><span style="opacity:0.5;font-size:13px;">(Benoit Montanié)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Jeunes Premiers</b></font><br/><span style="opacity:0.5;font-size:13px;">Le meilleur classement pour un premier rallye !</span></td> </tr>
							<tr title="Avec 4035 / 4590 points"> <td class="res-note">11</td> <td class="res-nom">这是什么 (Delacre-Legroux)</b><br/><span style="opacity:0.5;font-size:13px;">(Xavier Durand-Delacre)</span></td> </tr>
							<tr title="Avec 3983 / 4590 points"> <td class="res-note">12</td> <td class="res-nom">Eurekaladore</b><br/><span style="opacity:0.5;font-size:13px;">(Pierre Lanore)</span></td> </tr>
							<tr title="Avec 3925 / 4590 points"> <td class="res-note">13</td> <td class="res-nom">Le Palais Royal</b><br/><span style="opacity:0.5;font-size:13px;">(Jean-Philippe Sarcos)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Enluminure</b></font><br/><span style="opacity:0.5;font-size:13px;">Un des plus beau dossiers de réponses</span></td> </tr>
							<tr title="Avec 3898 / 4590 points"> <td class="res-note">14</td> <td class="res-nom">Les Montagnards</b><br/><span style="opacity:0.5;font-size:13px;">(Michel Vic)</span></td> </tr>
							<tr title="Avec 3867 / 4590 points"> <td class="res-note">15</td> <td class="res-nom">Le Clan des Sept</b><br/><span style="opacity:0.5;font-size:13px;">(Françoise Mellouk)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe One Touch</b></font><br/><span style="opacity:0.5;font-size:13px;">20 énigmes résolues pour 29 mots de passe testés</span></td> </tr>
							<tr title="Avec 3827 / 4590 points"> <td class="res-note">16</td> <td class="res-nom">Musico Balades</b><br/><span style="opacity:0.5;font-size:13px;">(Marie-Claude Amouroux)</span></td> </tr>
							<tr title="Avec 3727 / 4590 points"> <td class="res-note">17</td> <td class="res-nom">440</b><br/><span style="opacity:0.5;font-size:13px;">(Jacques Papon)</span></td> </tr>
							<tr title="Avec 3623 / 4590 points"> <td class="res-note">18</td> <td class="res-nom">Les Zigotos</b><br/><span style="opacity:0.5;font-size:13px;">(Claude Bon)</span></td> </tr>
							<tr title="Avec 3601 / 4590 points"> <td class="res-note">19</td> <td class="res-nom">Les Incollables du Macadam</b><br/><span style="opacity:0.5;font-size:13px;">(Michèle Bouhours)</span></td> </tr>
							<tr title="Avec 3498 / 4590 points"> <td class="res-note">20</td> <td class="res-nom">Verseau</b><br/><span style="opacity:0.5;font-size:13px;">(Sylvie Colleu Gourvennec)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Aléa</b></font><br/><span style="opacity:0.5;font-size:13px;">Plus de 500 mots de passe testés</span></td> </tr>
							<tr title="Avec 3473 / 4590 points"> <td class="res-note">21</td> <td class="res-nom">Les Quatres Cercles</b><br/><span style="opacity:0.5;font-size:13px;">(Charles Pautrat)</span></td> </tr>
							<tr title="Avec 3435 / 4590 points"> <td class="res-note">22</td> <td class="res-nom">Les Vivaldi</b><br/><span style="opacity:0.5;font-size:13px;">(Sylvie Clément)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Lièvre et la Tortue</b></font><br/><span style="opacity:0.5;font-size:13px;">21 énigmes résolues en 30 jours</span></td> </tr>
							<tr title="Avec 3287 / 4590 points"> <td class="res-note">23</td> <td class="res-nom">IH 61 & Compagnie</b><br/><span style="opacity:0.5;font-size:13px;">(Pierre Alleaume)</span></td> </tr>
							<tr title="Avec 3262 / 4590 points"> <td class="res-note">24</td> <td class="res-nom">En Avant la Zizique</b><br/><span style="opacity:0.5;font-size:13px;">(Nicole Deshaies)</span></td> </tr>
							<tr title="Avec 3148 / 4590 points"> <td class="res-note">25</td> <td class="res-nom">Berdinguette</b><br/><span style="opacity:0.5;font-size:13px;">(Nicolas Shimel)</span></td> </tr>
							<tr title="Avec 3096 / 4590 points"> <td class="res-note">26</td> <td class="res-nom">Notes'in'Gammes</b><br/><span style="opacity:0.5;font-size:13px;">(Véronique Adrover)</span></td> </tr>
							<tr title="Avec 3053 / 4590 points"> <td class="res-note">27</td> <td class="res-nom">Bémol</b><br/><span style="opacity:0.5;font-size:13px;">(Martine Lagain)</span></td> </tr>
							<tr title="Avec 3033 / 4590 points"> <td class="res-note">28</td> <td class="res-nom">Chevillon</b><br/><span style="opacity:0.5;font-size:13px;">(Olivier Martin)</span></td> </tr>
							<tr title="Avec 2847 / 4590 points"> <td class="res-note">29</td> <td class="res-nom">Diamétrale</b><br/><span style="opacity:0.5;font-size:13px;">(Philippe Laborie)</span></td> </tr>
							<tr title="Avec 2821 / 4590 points"> <td class="res-note">30</td> <td class="res-nom">Bisounours</b><br/><span style="opacity:0.5;font-size:13px;">(Christophe Garcia)</span></td> </tr>
							<tr title="Avec 2484 / 4590 points"> <td class="res-note">31</td> <td class="res-nom">Ze Dream Team</b><br/><span style="opacity:0.5;font-size:13px;">(Muriel Gilet)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Assistés</b></font><br/><span style="opacity:0.5;font-size:13px;">A bénéficié d'une aide conséquente de Terpsichore</span></td> </tr>
							<tr title="Avec 2356 / 4590 points"> <td class="res-note">32</td> <td class="res-nom">Happy Street Walkers</b><br/><span style="opacity:0.5;font-size:13px;">(Jean-Jacques Gavrel)</span></td> </tr>
							<tr title="Avec 2319 / 4590 points"> <td class="res-note">33</td> <td class="res-nom">Les Cornemuses</b><br/><span style="opacity:0.5;font-size:13px;">(Frédérique Stephan)</span></td> </tr>
							<tr title="Avec 2123 / 4590 points"> <td class="res-note">34</td> <td class="res-nom">Chérub</b><br/><span style="opacity:0.5;font-size:13px;">(Philippe Sadot)</span></td> </tr>
							<tr title="Avec 1769 / 4590 points"> <td class="res-note">35</td> <td class="res-nom">Le Quintette du Dinan</b><br/><span style="opacity:0.5;font-size:13px;">(Alain Resplandy-Bernard)</span></td> </tr>
							<tr title="Avec 1621 / 4590 points"> <td class="res-note">36</td> <td class="res-nom">Bobby</b><br/><span style="opacity:0.5;font-size:13px;">(Irène Darmon)</span></td> <td><img src="pictures/icon1.png" style="margin-top:5px;"></td> <td><font color="#76a7f2"><b>Coupe Acharnés</b></font><br/><span style="opacity:0.5;font-size:13px;">"insistance" lors des demandes d'indices !</span></td> </tr>
							<tr title="Avec 1477 / 4590 points"> <td class="res-note">37</td> <td class="res-nom">Le Quatuor</b><br/><span style="opacity:0.5;font-size:13px;">(Armelle Beunardeau)</span></td> </tr>
							<tr title="Avec 1011 / 4590 points"> <td class="res-note">38</td> <td class="res-nom">Les Pipoteurs</b><br/><span style="opacity:0.5;font-size:13px;">(Xavier Janin)</span></td> </tr>
							<tr title="Avec 512 / 4590 points"> <td class="res-note">39</td> <td class="res-nom">Les Cévenols</b><br/><span style="opacity:0.5;font-size:13px;">(Eric Bonté)</span></td> </tr>
							<tr title="N'ont pas rendu de dossier !"> <td class="res-note">∞</td> <td class="res-nom">Les Villepreusiens,<br/>La Petite Fugue,<br/>Genièvre,<br/>Les Hibernants,<br/>Les Othellistes,<br/>Dumas,<br/>Les Trilles,<br/>Toto,<br/>Debars,<br/>Michounet,<br/>Breizh Storming,<br/>...</td> </tr>
						</table>
					</div>

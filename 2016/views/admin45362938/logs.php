...
<script type="text/javascript">
	...
	function loadLogs (all) {
		...
		$('#log-table').load('views/admin45362938/logs.php?'+all+'justdata&team='+Fteam+'&enigme='+Fenigme+'&mdp='+Fmdp);
	}
</script>

<table>
<thead>
	<!--tr><th>Date</th><th>Equipe</th><th>Enigme</th><th>Mot de passe</th></tr-->
	<tr>
		<th>Date</th>
...
$SQL = 'SELECT * FROM rallye_try WHERE equipe != "terpsichore" AND equipe !="euterpe" '.$filters.' ORDER BY date DESC '.$limit;
//echo $SQL.'<br>';

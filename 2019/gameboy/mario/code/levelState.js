...
Mario.LevelState.prototype.Draw = function(context) {
    ...
    this.DrawStringShadow(context, "VIES " + Mario.MarioCharacter.Lives, 0, 0);
    //this.DrawStringShadow(context, "00000000", 0, 1);
    this.DrawStringShadow(context, "PIECES " + Mario.MarioCharacter.Coins, 13, 0);
    ...
    this.DrawStringShadow(context, "TEMPS " + time, 28, 0);
    ...
    if (Mario.MarioCharacter.WinTime > 0) {
    	Enjine.Resources.PauseSound("theme");
        Enjine.Resources.PauseSound("theme2");
...
Mario.LevelState.prototype.CheckForChange = function(context) {
	if (this.GotoLoseState) {
		...
		if (this.GotoMapState) {
            ...
            context.ChangeState(new Mario.LevelState(1, Math.floor(Math.random() * 3) ));

		}else if (this.GotoNextState){

            Enjine.Resources.PlaySound("theme2", 1);

...
<div class="docsutiles">
	...
	<a href="dossierreponse2019.pdf">
		<div class="file" style="color:#0bafd2;">
			<i class="fas fa-lightbulb"></i>
			Dossier des solutions
		</div>
	</a>
	<a href="classement.pdf">
		<div class="file" style="color:#0bafd2;">
			<i class="fas fa-medal"></i>
			Classement des équipes
		</div>
	</a>
	<a href="ressources/reglement_rh2019.pdf">
		<div class="file">
			<i class="fas fa-book"></i>
			Les règles du jeu
		</div>
	</a>
	<a href="ressources/guide_debutant_rh2019.pdf">
		<div class="file">
			<i class="fas fa-ambulance"></i>
			Guide du débutant en rallye
		</div>
	</a>
	<a href="ressources/RH2019 - Enigmes.pdf">
		<div class="file">
